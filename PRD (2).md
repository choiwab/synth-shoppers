...
Up to 3 automated improvement loops. Each loop produces a delta: before/after buy rate, which fix moved the needle.
...
- [ ] Automated improvement loop (up to 3 iterations)
